		...
		return (
			<div className="flex flex-col gap-4">
				<div className="flex items-center justify-between">
					...
					<button
						onClick={handleAdd}
						className="btn-mystia text-xs hover:bg-black/5 dark:hover:bg-white/5"
					>
						+ 添加商品
					</button>
				</div>
							...
							>
								<div className="flex items-center justify-between">
									...
									<button
										...
										className="btn-mystia-danger rounded-full px-3 py-1 text-xs opacity-0 transition-opacity group-hover:opacity-100"
									>
										删除
									</button>
								</div>
